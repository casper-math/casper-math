...
it.each([
    ...
    ['-a - b - a + b', '-2 * a'],
    ['8a + 4 - 8a + 2', '6'],
    ['-(2 / 3) * a - a * b - 3 * a * b + (1 / 5) * a', '-4 * a * b + (-7 / 15) * a'],
    ['2 * 3a + 6 * 5a', '36 * a'],
    ['3 * 4n - 2n * 7', '-2 * n'],
    ['5p * 3q - 2 * 4 * p * q', '7 * p * q'],
    ...
    ['3a - 2b - 2b * -a + 5a * -2b', '-8 * a * b + 3 * a - 2 * b'],
...
it.each([
    ...
    ['7 * a * b * (c + 3/14d)', '7 * a * b * c + (3 / 2) * a * b * d'],
    ...
    ['-3(a - 6b) - 2 * a * b - a * (b - 4)', '-3 * a * b + a + 18 * b'],
    ...
    ['-3p * -2q - q * (6p + 1)', '-1 * q'],
    ['(x - 1)(y + 1)', 'x * y + x - y - 1'],
    ['(4x - 1)(x + 3)', '4 * x ^ 2 + 11 * x - 3'],
    ['(2p - q)(p + 4q)', '2 * p ^ 2 - 4 * q ^ 2 + 7 * p * q'],
    ['(x + 3y)(x + 3y)', 'x ^ 2 + 9 * y ^ 2 + 6 * x * y'],
    ['(a + 7)(b + 9)', 'a * b + 9 * a + 7 * b + 63'],
    ['(x + 7)(x + 9)', 'x ^ 2 + 16 * x + 63'],
    ['(q + 4)(q - 5)', 'q ^ 2 - q - 20'],
    ['(p + 8)(p + 8)', 'p ^ 2 + 16 * p + 64'],
    ['(x + 6)(x - 1)', 'x ^ 2 + 5 * x - 6'],
...
it.each([
    ...
    ['x^2 * y^3 * x^5 * y^2', 'x ^ 7 * y ^ 5'],
    ['2 * a * b^3 * 5 * a^3 * b^2', '10 * a ^ 4 * b ^ 5'],
    ['3p^6 * -3p^6', '-9 * p ^ 12'],
    ['6x^2 * -3y * 2y^5 * -2x', '72 * x ^ 3 * y ^ 6'],
    ['7a^3 + 5a^3', '12 * a ^ 3'],
    ['3a^2 - 9a^2', '-6 * a ^ 2'],
    ['4a^4 - a^4', '3 * a ^ 4'],
    ['8b^8 - b^8', '7 * b ^ 8'],
    ...
    ['5a^3 + 5a^3', '10 * a ^ 3'],
    ['6x^6 - 7x^6', '-1 * x ^ 6'],
    ['2x^2 + 8y^2', '2 * x ^ 2 + 8 * y ^ 2'],
    ['8a^2 - 7a^2', 'a ^ 2'],
    ['10a^3 + 3', '10 * a ^ 3 + 3'],
    ['6a^2 - 10a', '6 * a ^ 2 - 10 * a'],
    ['5x^2 - 5x^2', '0'],
    ['7p^3 + 41p^3', '48 * p ^ 3'],
    ['2a^3 - 5a^3 + 7a^3', '4 * a ^ 3'],
    ['-x^2 - 2x^2 + 3x^3', '3 * x ^ 3 - 3 * x ^ 2']
])('can simplify powers', (input: string, output: string) => {
    const result = casper().go(input)
    expect(result.result).toBe(output)
})
